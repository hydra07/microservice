...
import { authenticateJWT, verifyToken } from '@/middleware/authJwt';
import { NextFunction, Request, RequestWithUser, Response, Router } from 'express';
...
router.get('/discord/admin', passport.authenticate('discord', { session: false }));