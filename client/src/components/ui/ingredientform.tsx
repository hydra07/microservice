  ...
  return (
    <div>
      {ingredients.map((ingredient, index) => (
        <div key={index}>
          ...
          <input
            ...
            className="border border-gray-300 p-2 mr-2 rounded-lg w-[30%]"
          ...
          <select
            ...
            onChange={(e) => handleIngredientChange(index, e)}
            className="border border-gray-300 p-2 rounded-lg w-[26%]"
          >
      ...
      <button
        ...
        className="bg-blue-500 text-white p-2 rounded-lg mr-2 mt-2 mb-4"
      >
        Add Input
      </button>
      <button
